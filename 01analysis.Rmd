...
```{r}
ace2_id <- gene_table$Ensembl_ID[gene_table$Gene_Name == "ACE2"]
```

```{r}
ace2_data <- as.data.frame(merge(ctrl.vs.cf[ace2_id, ], gene_table[ace2_id, ]))
```
...
```{r}
ace2_data <- as.data.frame(merge(ctrl.vs.het[ace2_id, ], gene_table[ace2_id, ]))
```
